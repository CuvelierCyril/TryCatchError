 ...
 */
final class Version20181220181249 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE subject (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, title VARCHAR(100) NOT NULL, content VARCHAR(10000) NOT NULL, date DATETIME NOT NULL, categories VARCHAR(100) NOT NULL, view INT NOT NULL, INDEX IDX_FBCE3E7AF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
