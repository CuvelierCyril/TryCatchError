$(document).ready(function(){
    ...
    $('#form-subject').submit(function(e){
        ...
        $('#Success').html('');
        $('#errorContent').html(`Contenu du sujet : <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalCode">Ajouter du code</button><button type="button" class="btn btn-danger ml-2 mr-2"  data-toggle="modal" data-target="#modalStyle">Texte stylisé</button>`);
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.content){
                    $('#errorContent').html(`Contenu du sujet : <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalCode">Ajouter du code</button><button type="button" class="btn btn-danger ml-2 mr-2"  data-toggle="modal" data-target="#modalStyle">Texte stylisé</button><span class="alert alert-danger">Format du contenu invalide</span>`);
                }
                if(data.description){
